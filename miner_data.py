...
class BOSminer:
    ...
    async def get_api_data(self):
        try:
            ...
            return {'IP': self.ip, 'Fans': {"fan_0": {"RPM": 0}, "fan_1": {"RPM": 0}}, 'HR': {"board_6": {"HR": 0}, "board_7": {"HR": 0}, "board_8": {"HR": 0}}, 'Temps': {'board_6': {'Board': 0, 'Chip': 0}, 'board_7': {'Board': 0, 'Chip': 0}, 'board_8': {'Board': 0, 'Chip': 0}}}
